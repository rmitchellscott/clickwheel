...
export function SettingsDialog() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-card rounded-xl shadow-xl border w-full max-w-lg mx-4 max-h-[85vh] overflow-y-auto">
        <div className="flex items-center justify-between p-4 border-b sticky top-0 bg-card rounded-t-xl z-10">
        ...
        <div className="p-4 space-y-6">
          <section className="space-y-1">
            <h3 className="text-sm font-medium text-muted-foreground uppercase tracking-wider mb-2">Appearance</h3>
          ...
          <section className="space-y-1">
            <h3 className="text-sm font-medium text-muted-foreground uppercase tracking-wider mb-2">Music</h3>
            <SettingRow
          ...
          <section className="space-y-1">
            ...
            <div className="flex items-start justify-between gap-4 py-2">
              <div className="min-w-0">
                <div className="text-sm">Split long audiobooks</div>
                {splitBooks ? (
                  <div className="text-xs text-muted-foreground mt-0.5 flex items-center gap-1">
                    Split audiobooks longer than
                    <Input
                      type="number"
                      min="1"
                      max="99"
                      ...
                      className="w-12 h-5 text-xs text-center inline-block mx-0.5 px-1"
                    />
                    hours into parts
                  </div>
                ) : (
                  <div className="text-xs text-muted-foreground mt-0.5">Long single-file audiobooks can cause instability on older iPods</div>
                )}
              </div>
        ...
        <div className="p-4 border-t flex justify-end gap-2 sticky bottom-0 bg-card rounded-b-xl">
